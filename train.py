...
def main(config_data_file: str, version: str):
    ...
    train_data = UbuntuDataSet(config['root'] + config['target'], config['raw']['train'])
    ...
    trainer = pl.Trainer(
        gpus=1, num_nodes=1, distributed_backend="ddp", amp_level='O2', amp_backend='native', max_epochs=10,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_data_file", default="./conf/dataset/ubuntu.yml", type=str)
